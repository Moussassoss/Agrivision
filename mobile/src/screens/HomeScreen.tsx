              ...
              <View style={styles.heroLeft}>
                ...
                <View style={{ flexDirection: "row", gap: 8 }}>
                  <TouchableOpacity
                    style={[
                      styles.heroBtn,
                      (!location || loadingRec) && styles.heroBtnDisabled,
                      { flex: 1 },
                    ]}
                  ...
                  {[
                    ...
                    <View key={key} style={styles.inputGroup}>
                      ...
                      <TextInput
                        ...
                        onChangeText={(v) =>
                          setSoilOverride({ ...soilOverride, [key]: v })
                        }
...
const DataTile = ({ label, value, unit, color }: any) => (
  <View style={[styles.dataTile, { backgroundColor: color }]}>
    ...
    <Text style={styles.dataTileValue}>
      {value}<Text style={styles.dataTileUnit}> {unit}</Text>
    </Text>
  </View>
);

const TabItem = ({ emoji, label, active, onPress }: any) => (
...
const styles = StyleSheet.create({
  ...
  topBar:          { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 20, paddingTop: 12, paddingBottom: 8, borderBottomWidth: 0.5, borderBottomColor: "#F0F0F0" },
  ...
  overrideHeader:  { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: "#F9F9F9", borderRadius: 14, padding: 16, borderWidth: 0.5, borderColor: "#EBEBEB" },
  overrideTitle:   { fontSize: 15, fontWeight: "700", color: "#1a1a1a", marginBottom: 2 },
  overrideSub:     { fontSize: 12, color: "#888" },
  overrideChevron: { fontSize: 13, color: "#888" },
  overrideCard:    { backgroundColor: "#F9F9F9", borderRadius: 14, padding: 16, borderWidth: 0.5, borderColor: "#EBEBEB", marginTop: -8, gap: 12 },
  overrideNote:    { fontSize: 12, color: "#999" },
  inputGrid:       { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  inputGroup:      { width: "47%" },
  inputLabel:      { fontSize: 11, fontWeight: "600", color: "#555", marginBottom: 5 },
  input:           { backgroundColor: "#fff", borderWidth: 0.5, borderColor: "#DCDCDC", borderRadius: 10, padding: 11, fontSize: 14, color: "#1a1a1a" },
  clearBtn:        { alignSelf: "center", paddingVertical: 6, paddingHorizontal: 16, borderRadius: 20, borderWidth: 0.5, borderColor: "#ccc" },
  clearBtnText:    { fontSize: 12, color: "#888" },

  historyCard:     { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F9F9F9", borderRadius: 14, padding: 16, borderWidth: 0.5, borderColor: "#EBEBEB" },
  historyLeft:     { flexDirection: "row", alignItems: "center", gap: 12 },
  historyEmoji:    { fontSize: 28 },
  historyTitle:    { fontSize: 15, fontWeight: "700", color: "#1a1a1a", marginBottom: 2 },
  historySub:      { fontSize: 12, color: "#888" },
  historyChevron:  { fontSize: 22, color: "#ccc", fontWeight: "700" },
  ...
  altCard:         { flex: 1, backgroundColor: "#F9F9F9", borderRadius: 14, padding: 14, alignItems: "center", gap: 6, borderWidth: 0.5, borderColor: "#EBEBEB" },
  altName:         { fontSize: 14, fontWeight: "700", color: "#1a1a1a", textAlign: "center" },
  altPill:         { backgroundColor: "#E8F5E9", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 3 },
  altPillText:     { color: "#2D6A4F", fontSize: 12, fontWeight: "700" },

  dataCard:        { backgroundColor: "#F9F9F9", borderRadius: 14, padding: 14, borderWidth: 0.5, borderColor: "#EBEBEB", gap: 12 },
  ...
  secondaryBtnText:{ color: "#2D6A4F", fontWeight: "600", fontSize: 14 },

  tabBar:          { flexDirection: "row", borderTopWidth: 0.5, borderTopColor: "#F0F0F0", backgroundColor: "#fff", paddingBottom: 24, paddingTop: 10 },
